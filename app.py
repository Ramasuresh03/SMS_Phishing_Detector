...
# Try to create the model object; fall back to gemini-1 if needed
try:
    gemini_model = genai.GenerativeModel(GEMINI_MODEL_ID)
except Exception as e:
    print(f"Model init warning: couldn't create model '{GEMINI_MODEL_ID}': {e}. Falling back to 'gemini-1'.")
    try:
        gemini_model = genai.GenerativeModel("gemini-1")
